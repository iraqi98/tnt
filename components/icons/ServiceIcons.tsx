export function DiagnosticIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6}>
      ...
      <path d="M6 9l2.5 4L11 8l1.5 3L15 9" />
    </svg>
  );
}
...
export function PaintIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6}>
      <path d="M14 3l7 7-8.5 8.5a3 3 0 01-2.12.88H7v-3.38a3 3 0 01.88-2.12z" />
      <path d="M14 3l-9 9M17 6l1.5-1.5a2 2 0 10-2.83-2.83L14.17 3.17" />
    </svg>
  );
}
...
export function BodyIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6}>
      <path d="M3 15l2-6h5l1-3h6l2 3h2l-2 6" />
...
export function FuelIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6}>
      <path d="M6 3h8v18H6z" />
      <path d="M14 8h2a2 2 0 012 2v6a1.5 1.5 0 003 0v-5l-3-3" />
      <path d="M6 10h8" />
    </svg>
  );
}
